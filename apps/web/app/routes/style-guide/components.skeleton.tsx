...
export default function ComponentsSkeleton() {
  return (
    <div className="px-4 sm:px-8 py-10 space-y-12">
      <PageIntro
        title="Skeleton"
        blurb="A pulsing placeholder for content that's loading. Compose it with width/height utilities to mirror the real layout, so the page doesn't jump when data arrives."
      >
        <div className="mt-4">
          <CodeBlock
...
<Skeleton className="size-9 rounded-full" />`}
      ...
      <SpecimenSection title="Card placeholder">
